...
<input type="hidden" id="adultPrice" value="<?php echo htmlentities($result->PackagePrice); ?>">
<input type="hidden" id="childrenPrice" value="<?php echo htmlentities($result->PackagePrice) * 0.5; ?>">
